                        ...
                        result.posts.forEach(post => {
                            ...
                            postElement.innerHTML = `
                                <div class="post-header-card">
                                    <h3 class="post-card-title">${post.title || 'Judul Tanpa Nama'}</h3>
                                    <span class="post-status ${statusClass}">${statusText}</span>
                                </div>
                                <p class="post-card-synopsis">${post.synopsis || 'Tidak ada sinopsis.'}</p>
                                <div class="post-meta-card">
                                    <div class="author-info-card">
                                        <img src="${authorAvatar}" alt="Author Avatar" class="author-avatar-card">
                                        <span class="author-name-card">${authorName}</span>
                                    </div>
                                    <div class="dates-info-card">
                                        <span class="publish-date-card">Publikasi: ${publishDate}</span>
                                        <span class="edited-date-card">Diedit: ${editedDate}</span>
                                    </div>
                                </div>
